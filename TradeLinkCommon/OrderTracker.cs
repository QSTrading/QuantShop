...
namespace TradeLink.Common
{
    ...
    public class OrderTracker  : GotOrderIndicator,GotCancelIndicator,GotFillIndicator,GenericTrackerI
    {
        ...
        /// 已经取消,已发送!=已成交 均为pending Order 需要被filled
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// see if an order was completely filled 查看某个Order是否完全成交
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// see if order was canceled 查看某个Order是否被取消
        /// </summary>
        ...
        /// <summary>
        /// returns sent size of an order 返回某个Order提交委托数量
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// returns filled size of an order 返回某个Order已成交数量
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// gets entire sent order 返回某个提交的委托(Order)
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// get unfilled portion of order from index 返回某个Order未成交数量
        /// </summary>
        ...
        /// <summary>
        /// returns true if order is known to tracker 查看某个Order是否被维护跟踪
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
