...
namespace ZMQ
{
    ...
    {
        public KVMessage(long sequence, string key = "", string body = "")
        {
            Sequence = sequence;
            Key = key;
            Body = body;
        ...
        public static KVMessage Recv(Socket subscriber)
        {
            ...
            return new KVMessage(sequence, key, body);
        }
        ...
        public void Store(IDictionary<string, KVMessage> dict)
        {
